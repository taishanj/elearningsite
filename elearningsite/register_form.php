...
<body>
  ...
  <div class="container">
    ...
    <!--Radio button for student or teacher profile-->
    <!--
     <label for="statusinfo"><b>Are You A Tutor Or Student?</b></label><br>
     
     <input type="radio" name="status" value="student"> Student<br>
     <input type="radio" name="status"value="tutor"> Tutor<br>
